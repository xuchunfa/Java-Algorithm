...
public class IsHasSubtree {
    ...
    //        }*/
    //        if(!result){
    //            result = isSubtree(root1.left,root2) || isSubtree(root1.right,root2);//左子树要是找到直接返回
    //        }
    //
    //    }
    //
    ...
    public static void main(String[] args){
        ...
        System.out.println(HasSubtree(root1.getRoot(),root2.getRoot()));
    }
}
